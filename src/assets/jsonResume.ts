export const resume =
{
  ...
  "work": [
    ...
    },
    {
      ...
      "startDate": "2016-08",
      "endDate": "2018-06",
      "summary": "I worked for different clients and projecs. Here a list of the most relavant ones:<ul class=\"projects-list\"><li><b>UBS Connections (Jive) for UBS</b><div><b>Description:</b> Building, customization and mantainance of UBS internal network platform (UBS Connections) based on Jive.<br><b>Activities:</b> Theaming in Jive, developing Jive Plugins and Tiles, plan and implement integrations with other UBS systems, tasks estimation, SQL scripting, writing documentation, rolling out versions.<br><span class=\"keywords-and-techs\"><b>Keywords and technologies:</b> Jive, REST, Docker, Java, Oracle, SQL, Git, Freemarker templates, Soy templates, Javascript, JQuery, CSS</span></div></li><li><b>Internal projects: Floripa and Papyrus</b><div><b>Description:</b> Designing and Development of the new ti&amp;m blog, products and main corporate websites. All based on Magnolia CMS.<br> <b>Activities</b>: Magnolia backend development, designing of Magnolia components, CMS configuration, frontend integration, deployments, direct customer support, documentation writing, testing.<br><span class=\"keywords-and-techs\"><b>Keywords and technologies:</b> Magnolia CMS, Git, Java, JCR, LDAP, Maven, Tomcat, Freemarker templates, Javascript, JQuery.</span></div></li><li><b>Web App prototype for Bigdata analisys</b><div><b>Description:</b> Development of a web app prototype for extracting and analyzing big chuncks email data visualizing the results on meaningful charts and graphs. <br> <b>Activities:</b> Analysis, planning, backend programming, testing.<br><span class=\"keywords-and-techs\"><b>Keywords and technologies:</b> Java, Apache Spark, Spring, Maven, Git.</span></div></li></ul>   ",
      "highlights": []
    },
    {
      "company": "GFT",
  ...
  "volunteer": [
    {
      "organization": "Officina delle idee, Messina",
      "position": "Co-coordinator of a free course on C/C++",
      "website": "",
      "startDate": "2012-01",
      "endDate": "2012-03",
      "summary": "Course manager, teacher of the basics of \"C Language\" and writer of educational materials.",
      "highlights": []
    }
  ],
  "education": [
    ...
    },
    {
      ...
      "endDate": "2016-07",
      "gpa": "",
      "info": "Formative and competitive course with the goal of <b>inserting few selected software engineers in the Swiss market</b>.<br/><br>I was <b>one of the 9 finalists</b> which was hired by the swiss company <b>ti&m</b>",
      "courses": [
      ]
    },
    {
  ...
  "awards": [
    {
      ...
      "summary": "Prize awarded to the top students of the Department of Science and Technology of the University of Messina. <br/>Top students list: <span class=\"link-in-content\">bit.ly/2QUTqwk</span> (search for \"Fazio Giulian\")"
    }
  ],
  "publications": [],
  "skills": [
